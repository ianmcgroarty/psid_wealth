...
*Date: 06.07.2018
*Description: This file renames PSID mortgage data
*********************************************************************************

clear all
set more off

use "\\c1resp3\Retail_Risk_Analysis\Non_Restricted_Research\Kiser\PSID\PSID_Jessica\data\raw\mortgage_psid_raw.dta", clear
...
*homeowner
* owns = 1, pays rent = 5, neither = 8, 9=wild
...
save "\\c1resp3\Retail_Risk_Analysis\Non_Restricted_Research\Kiser\PSID\PSID_Jessica\data\raw\mortgage_psid_renamed.dta,replace 
