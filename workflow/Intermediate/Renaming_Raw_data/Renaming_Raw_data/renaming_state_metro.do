...
import delimited Y:\PSID_Jessica\data\Untouched\HPI_AT_state.csv, clear 
	rename v1 state_ 
	rename v2 year
	rename v3 qtr
	rename v4 hpi 
...
use "Y:\PSID_Jessica\data\raw\state_metro_psid_raw.dta", clear
...
save Y:\PSID_Jessica\data\raw\state_metro_psid_renamed.dta, replace
